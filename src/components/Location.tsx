...
const locationDetails = [
  {
    ...
    description: "Adjacent to Area 2 (Student Accommodation)"
  },
  {
    icon: Route,
    title: "Contains Key Buildings",
    description: "Dining Hall, Admin Block, and Gathering Building"
  },
  {
    icon: TreePine,
    title: "RANGERS OVERLAY Zone",
    description: "Located within GREEN HATCH AREA"
  }
];
