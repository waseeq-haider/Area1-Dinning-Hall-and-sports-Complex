import heroImage from "@/assets/Dining HAll and Sport Complex.jpeg";
      ...
      <div className="relative h-full flex items-center justify-center px-6">
        <div className="max-w-5xl mx-auto text-center animate-fade-up">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-primary-foreground mb-6 tracking-tight">
            Area 1 – Dining Hall & Sports Complex
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl text-primary-foreground/90 mb-12 font-light">
            The functional core of the retreat, focused on gathering, dining, and connection.
          </p>
          <Button
            size="lg"
            variant="secondary"
